...
export default function RegisterForm(){
    ...
    <div className="side">
        <form className="form" onSubmit={handleSubmit}>
            <h2><span><i className="fa-solid fa-user"></i></span>Login</h2>
            <div>
                <label>Name</label>
                <input
                    type="text"
        ...
        </form>
        {
            ...
            // submitting the form will reveal nameCard with card flicking animation
            isSubmit &&
            <div style={{backgroundColor: submitDetails.userColor}} className={isAnimated ? 'card':''} id={submitDetails.userColor}>
                <h1><span><i className="fa-solid fa-address-card"></i></span>{submitDetails.userName}</h1>
                <h3><span><i className="fa-solid fa-phone"></i></span>{submitDetails.userPhone}</h3>
                <h3><span><i className="fa-solid fa-envelope"></i></span>{submitDetails.userEmail}</h3>
            </div>
        }
    </div>
    )

...
// import context
import { MainContext } from "../main/context/MainProvider";
...
export default function Navitems(){
    ...
    // animation is for animation state
    ...
    const clickTab= (e) => {
        ...
        // clicking the list will start animation in the header
        setAnimation(true);
        setTimeout(() => {
            setAnimation(false);
        }, 3000);
    ...
    return(
        <div className="main">
            <header>
                ...
                <h1 className={animation?"drop":''}>{topic}</h1>
